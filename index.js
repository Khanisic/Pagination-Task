...
var container = myDOM('div', 'container mt-3', 'container')
document.body.append(container);

var table = myDOM('table', 'table table-dark table-striped')
container.append(table);

var thead = myDOM('thead');
table.append(thead);
...
for (i = 1; i <= 3; i++) {
    this["th" + i] = myDOM('th');
    this["th" + i].setAttribute('scope', 'col');
}
for (i = 1; i <= 3; i++) {
    tr.append(this["th" + i]);
}
...
var nav = myDOM('nav', 'mt-3');
nav.setAttribute('aria-label', 'Page navigation example')
container.append(nav)

var uli = myDOM('ul', 'pagination');
nav.append(uli)

for (i = 1; i <= 10; i++) {
    this["page" + i] = myDOM('li', elemClass = 'page-item');
}
uli.append(page1, page2, page3, page4, page5, page6, page7, page8, page9, page10);

for (i = 1; i <= 10; i++) {
    this["link" + i] = myDOM('a', elemClass = 'page-link');
    this["link" + i].innerHTML = i;
}

for (i = 1; i <= 10; i++) {
    this["page" + i].append(this["link" + i]);
}
// var Previous = myDOM('li', elemClass = 'page-item');
// uli.prepend(Previous);
// var PreviousText = myDOM('a', elemClass = 'page-link');
// PreviousText.innerHTML = "Previous"
// Previous.append(PreviousText);

// var Next = myDOM('li', elemClass = 'page-item');
// uli.append(Next);
// var NextText = myDOM('a', elemClass = 'page-link');
// NextText.innerHTML = "Next"
// Next.append(NextText);

function myDOM(elem, elemClass = "", elemID = "", elemStyle = "") {
...
display(0,9);
for (j = 1; j <= 10; j++) {
    this["link" + j].addEventListener('click', function (j) {
        if (this.innerHTML == 1) {
            display(0,9);
